...
class OIDCAuthenticationBackend(ModelBackend):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.USERNAME_ALGO = import_from_settings('OIDC_USERNAME_ALGO', None)
        ...
        self.OIDC_STORE_ACCESS_TOKEN = import_from_settings('OIDC_STORE_ACCESS_TOKEN', False)
        self.OIDC_STORE_ID_TOKEN = import_from_settings('OIDC_STORE_ID_TOKEN', False)
    ...
    def verify_claims(self, claims):
        ...
        if 'email' in self.OIDC_RP_SCOPES.split():
    ...
    def get_username(self, claims):
        ...
        if self.USERNAME_ALGO:
            if isinstance(self.USERNAME_ALGO, six.string_types):
                self.USERNAME_ALGO = import_string(self.USERNAME_ALGO)
            return self.USERNAME_ALGO(claims.get('email'))
    ...
    def authenticate(self, request, **kwargs):
        ...
        reverse_url = self.OIDC_AUTHENTICATION_CALLBACK_URL
    ...
    def store_tokens(self, access_token, id_token):
        ...
        if self.OIDC_STORE_ACCESS_TOKEN:
            session['oidc_access_token'] = access_token

        if self.OIDC_STORE_ID_TOKEN:
